...
// Team Member Photos
import member1a from '../assets/team/member1.avif';
import member1b from '../assets/team/member2.avif';
import member2a from '../assets/team/member3.avif';
import member2b from '../assets/team/member4.avif';
import member3a from '../assets/team/member5.avif';
import member3b from '../assets/team/member6.avif';
import member4a from '../assets/team/member7.avif';
import member4b from '../assets/team/member8.avif';
import member5a from '../assets/team/member9.avif';
import member5b from '../assets/team/member10.avif';
...
import asimAzhar from "../assets/team/asimAzhar2.jpg"
// SVG Doodles
const GreenDoodle = () => <svg viewBox="0 0 250 250" className="absolute top-1/2 right-0 w-1/2 h-auto text-teal-500 z-0 transform -translate-y-1/2" fill="currentColor"><path d="M245.5 125.5Q248 151 234 167Q220 183 214 206.5Q208 230 185.5 231Q163 232 145.5 241Q128 250 109 243Q90 236 71 228Q52 220 38.5 204Q25 188 15.5 169Q6 150 15.5 131Q25 112 30 89.5Q35 67 57.5 57.5Q80 48 94 30.5Q108 13 131.5 11Q155 9 174 19Q193 29 210 37Q227 45 236.5 64.5Q246 84 245.5 104.5Q245 125 245.5 125.5Z" /></svg>;
const BlueDoodle = () => <svg viewBox="0 0 250 250" className="absolute bottom-0 left-0 w-1/3 h-auto text-blue-500 z-0" fill="currentColor"><path d="M245.5 125.5Q248 151 234 167Q220 183 214 206.5Q208 230 185.5 231Q163 232 145.5 241Q128 250 109 243Q90 236 71 228Q52 220 38.5 204Q25 188 15.5 169Q6 150 15.5 131Q25 112 30 89.5Q35 67 57.5 57.5Q80 48 94 30.5Q108 13 131.5 11Q155 9 174 19Q193 29 210 37Q227 45 236.5 64.5Q246 84 245.5 104.5Q245 125 245.5 125.5Z" /></svg>;


// --- TEAM DATA ARRAY ---
const teamData = [
    {
        images: [asimAzhar, member1b],
        alt: 'Team member 1',
        sticker: "",
        // Mobile-first: smaller size, adjusted position. md: uses original values.
        position: 'absolute top-[2%] left-[10%] w-48 h-64 md:left-[15%] md:w-72 md:h-96 z-10',
        stickerPosition: ""
    },
    {
        images: [member4a, member4b],
        alt: 'Team member 4',
    ...
    {
        images: [member2a, member2b],
        alt: 'Team member 2',
        sticker: stickerHands,
        // Mobile-first: smaller size, moved from edge. md: uses original values.
        position: 'absolute top-[10%] right-[5%] w-44 h-44 md:top-[8%] md:right-[0%] md:w-72 md:h-72 z-20',
        stickerPosition: "top-32 -right-6 md:-right-12 w-24 md:w-32"
    },
    {
        images: [member3a, member3b],
        alt: 'Team member 3',
        // Mobile-first: smaller size, adjusted position. md: uses original values.
        position: 'absolute top-[30%] right-[10%] w-48 h-48 md:top-[32%] md:right-[30%] md:w-72 md:h-72 z-10'
    },
    {
        images: [member5a, member5b],
        alt: 'Team member 5',
        sticker: stickerHi,
        // Mobile-first: smaller size, adjusted position. md: uses original values.
        position: 'absolute top-[42%] right-[8%] w-44 h-44 md:right-[12%] md:w-72 md:h-72 z-10',
        stickerPosition: "top-5 -left-12 w-20 -rotate-12"
    },
    {
        images: [member4b, member3a],
        alt: 'Team member 5',
        sticker: stickerJoinClub,
        // Mobile-first: smaller size. md: uses original values.
        position: 'absolute top-[52%] left-[5%] w-48 h-64 md:top-[50%] md:left-[8%] md:w-72 md:h-[360px] z-20',
        stickerPosition: "top-1/3 -left-10 md:-left-16 w-24 md:w-32"
    },
    {
        images: [member2a, member4a],
        alt: 'Team member 5',
        sticker: stickerLetsGo,
        // Mobile-first: smaller size, adjusted position. md: uses original values.
        position: 'absolute top-[68%] right-[5%] w-48 h-64 md:top-[69%] md:right-[18%] md:w-72 md:h-[360px] z-10',
        stickerPosition: "-bottom-2 md:bottom-2 -right-7 md:-right-12 w-24 md:w-32 -rotate-[30deg]"
    },
    {
        images: [member2b, member4b],
        alt: 'Team member 5',
        sticker: stickerHands,
        // Mobile-first: smaller size, adjusted position. md: uses original values.
        position: 'absolute md:hidden top-[82%] left-4 w-48 h-64 md:top-[69%] md:right-[18%] md:w-72 md:h-[360px] z-10',
    ...
    return (
        <section className="relative overflow-x-hidden bg-black text-white w-full  pt-20 px-8 flex flex-col items-center">
            ...
            <div className="relative w-full max-w-6xl  h-[280vh] ">
                ...
                <img className='w-96  absolute top-[0] right-[5%]' src={greenBlob} alt="" />
                <img className='w-96 absolute top-[55%] -left-[10%] ' src={blob2} alt="" />
                <RoundedArrow className='w-44 absolute top-[25%] left-[48%] lg:left-[32%] rotate-[45deg] ' color={"white"} />


                {/* Team Member Cards */}
                {teamData.map((member, index) => (
                    <div key={index} className={`rounded-xl shadow-2xl ${member.position}`}>
                        <FadingImage
                        ...
                        />
                        {member.sticker && (
                            <Popup className={`absolute ${member.stickerPosition}  transform  drop-shadow-lg z-[70]`}>
