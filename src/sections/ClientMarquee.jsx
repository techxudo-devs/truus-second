...
const ClientsMarquee = () => {
    ...
    return (
        <section data-navbar-theme="light" className="relative w-full px-10 lg:pr-10 min-h-screen bg-gradient-to-b from-[#002744] to-[#047fdd] flex items-center overflow-hidden">
