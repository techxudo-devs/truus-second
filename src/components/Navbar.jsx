...
const Navbar = () => {
  ...
  const baseTextColor = isHome ? 'text-white' : 'text-black'
      ...
      <div className="w-full max-w-6xl mx-auto px-8 xl:px-0">
        <div className="flex justify-between items-center">
          ...
          >
            ...
            />
            <span
              className={`${hover || !isHome ? 'text-black' : 'text-white'} z-50 relative font-extrabold max-md:text-3xl max-xl:text-4xl transition-all duration-200 ease-in-out text-3xl epilogue`}
            >
              work
            </span>
            <motion.div
          ...
          <Link to="/">
            <img className="w-40 md:w-60 h-full" src={logo2} alt="Truus" />
          </Link>
          ...
          <div
            ...
            onClick={!isDesktop ? () => setWhatsappHover((prev) => !prev) : undefined}
          >
            <IoLogoWhatsapp
            ...
            >
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm sm:text-base">Scan the QR code to chat with us via your smartphone.</p>
                </div>
                <div>
